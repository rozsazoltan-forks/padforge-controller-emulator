"""#162: add the Devices-page "Power" section header across all 10 locales.
Idempotent, BOM-preserving. Anchored after Devices_IdleDisconnect."""
...
KEYS = {
    "Devices_Power": ["Power", "Energie", "Energía", "Alimentation", "Alimentazione", "電源", "전원", "Energie", "Energia", "电源"],
}

ANCHOR = "Devices_IdleDisconnect"
