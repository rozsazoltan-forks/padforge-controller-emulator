...
namespace PadForge.SteamWorkshop.Tests
{
    ...
    public class TranslationGoldenTests
    {
        private static readonly long[] AllFixtureIds =
        {
            ...
            2494749393, 2774979654, 2790927974, 2795727040, 2853328208,
            2858159083, 2948704083, 3353173512, 3353604014, 3354224367,
            3443409487, 3451446931, 3456927474, 3725174032,
        };
