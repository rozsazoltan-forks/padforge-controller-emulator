...
public class Strings : INotifyPropertyChanged
{
    ...
    public string Settings_HeadTracking => Get("Settings_HeadTracking");
    public string Settings_HeadTrackingDesc => Get("Settings_HeadTrackingDesc");
    public string Settings_HeadTrackingEnable => Get("Settings_HeadTrackingEnable");
    public string Settings_HeadTrackingEnable_Tooltip => Get("Settings_HeadTrackingEnable_Tooltip");
    public string Settings_HeadTrackingFreeTrack => Get("Settings_HeadTrackingFreeTrack");
    public string Settings_HeadTrackingFreeTrack_Tooltip => Get("Settings_HeadTrackingFreeTrack_Tooltip");
    public string Settings_HeadTrackingPort => Get("Settings_HeadTrackingPort");
    public string Settings_HeadTrackingPort_Tooltip => Get("Settings_HeadTrackingPort_Tooltip");
    public string Settings_HeadTrackingRotationRange => Get("Settings_HeadTrackingRotationRange");
    public string Settings_HeadTrackingRotationRange_Tooltip => Get("Settings_HeadTrackingRotationRange_Tooltip");
    public string Settings_HeadTrackingTranslationRange => Get("Settings_HeadTrackingTranslationRange");
    public string Settings_HeadTrackingTranslationRange_Tooltip => Get("Settings_HeadTrackingTranslationRange_Tooltip");
